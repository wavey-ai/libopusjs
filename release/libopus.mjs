...
function findWasmBinary() {
  if (Module["locateFile"]) {
    return locateFile("libopus.wasm");
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL("libopus.wasm", import.meta.url).href;
}
...
var _Encoder_new = Module["_Encoder_new"] = wasmExports["k"];

var _Encoder_delete = Module["_Encoder_delete"] = wasmExports["l"];

var _Encoder_enc_frame = Module["_Encoder_enc_frame"] = wasmExports["m"];

var _Decoder_new = Module["_Decoder_new"] = wasmExports["n"];

var _Decoder_delete = Module["_Decoder_delete"] = wasmExports["o"];

var _Decoder_dec_frame = Module["_Decoder_dec_frame"] = wasmExports["p"];

var _opus_malloc = Module["_opus_malloc"] = wasmExports["q"];

var _malloc = Module["_malloc"] = wasmExports["r"];

var _opus_free = Module["_opus_free"] = wasmExports["s"];

var _free = Module["_free"] = wasmExports["t"];

var __emscripten_timeout = wasmExports["u"];
...
function Encoder(ch, rate, br, fsz) {
  ...
  this.out = Module._opus_malloc(4e3);
}
...
Encoder.prototype.enc_frame = function(samples) {
  ...
  const n = Module._Encoder_enc_frame(this.ptr, this.in, samples.length, this.out, 4e3);
  if (n <= 0) return {
    ok: false,
    encodedData: null
  };
  return {
    ok: true,
    encodedData: Module.HEAPU8.slice(this.out, this.out + n)
  };
};
...
function Decoder(ch, rate, fsz) {
  ...
  this.fsz = fsz;
  this.ch = ch;
  this.in = Module._opus_malloc(4e3);
